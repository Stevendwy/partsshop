  ...
  <div class="alipay">
    <div class="content">
      <div class="code-info">
        ...
        <img class="qrc-img" :src="qrImgUrl || '/static/img/img_loading.png'" alt="二维码">
...
export default {
  ...
  methods: {
    ...
    aData() {
      ...
      this.aQRData({order: this.order, payType: 'alipay'})
        .then(() => this.loopStart())
    },
    loopStart() {
      ...
      this.loopInterval = setInterval(() => {
        u.get('/pays/check/alipay', {order_id: this.info.orderid,}, {closeMum: true})
          .then(res => {
